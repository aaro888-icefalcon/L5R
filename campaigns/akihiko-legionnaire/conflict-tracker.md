...
- **Terms:** katana only; blades start sheathed (draw no earlier than first turn); field armor worn (both **Physical 3**); witnessed by both lines of men (judges).
...
|---|---|---|---|---|---|
| Toritaka Akihiko | 0 / 10 | **3 / 8** | none | 2/2 | Compromised at strife ≥8 → opponent gets a finishing blow. Katana Dmg 4 / Deadly 5 (1h). MA 1, Fire 3. |
| Matsu Kasumi | 0 / 14 | 1 / 14 | none | 2/2 | Superior duelist (MA ~3, Fire 3). Centered, patient. |
