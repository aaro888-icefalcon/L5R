...
8. **The poisoned camp — find the hand killing the Legion (Saburō's charge)** *(w1)* — Sc.3-5 arc: poison contained, camp cured, assassin Jōji caught — then DEAD under interrogation, the clean proof lost with him. Established: the Lion poisoned the Emperor's Legion to blind it for the western strike (NOT Scorpion). But the evidence is all circumstantial — cured sickness, dead assassin, coded ledger, Sukune's foreknowledge-impression. Saburō's NEW CHARGE: keep pulling the thread quietly/deniably/fast and bring proof a magistrate can't laugh off — before Akodo Shizue (who marked Akihiko) pulls her own threads. To accuse the Lion's Right Hand without proof = suicide.
...
## Current scene — Scene 5: *The Report* → **CLOSED · SESSION PAUSE (end of Day 1, midday)**
- **Sc.5 outcome:** Akihiko returned to a recovering camp and the gut-punch — **Jōji died under Tetsuo's interrogation** (the brutal route he chose) without naming the paymaster; the coded papers name no one. The clean proof is gone. He reported the whole morning to **Saburō** and presented **Sukune**. Fate (Likely → Yes): Saburō's contempt turned to **RELIANCE** — *"your grandfather could never finish a thing; you finished three before noon. I withdraw the comparison."* **Glory 32 → 36** (the turned-column story spreads). The strings: Saburō gives a new charge — **prove the Lion's guilt quietly/deniably/fast, or it's both their heads** — and **Akodo Shizue has marked Akihiko.**
- **Akihiko's state (session end):** **strife 7/8** (holding the mask by will — a break is owed, player's call when), fatigue **3/10**, **Void 1/2**, no wounds. **Honor 57 · Glory 36 · Status 36.** Title Gunsō (0/24xp). With his samurai; the witness Sukune in camp.
- **Where to pick up (Day 2+):** the unprovable Lion conspiracy (build proof before Shizue strikes) · Daidoji Sukune & the Crane as allies/witnesses · the debt to Matsu Kasumi (who fought clean over a dirty victory she doesn't know about) · the war grinding on at Toshi Ranbo · uncle Tadanobu's reaction incoming · Akihiko's frayed edge (an unmask owed).
- **Chaos:** held at **6.**
