...
## Current scene — Scene 3: *The Completer* (the dawn reckoning, ALTERED → Turning Point) → **IN PROGRESS**
- **Where / when:** the Imperial Legion camp on the ridge above Toshi Ranbo, first light; the camp in crisis.
- **What turned (Scene Test ALTERED → TP; themes Personal-heavy):** Akihiko rode up to confess the lost road and instead found the camp **poisoned** — a feast-night sabotage (stone-fruit-kernel toxin in the sake; a fifth of the company mad or dead). **taisa Seppun Saburō** — who *knew grandfather Michio* (Meaning: *Neglect·Completion* → "brilliant men who neglect their duty and leave better men to complete it") — has no officer to spare to punish, so he sets his sun-priest-medic to it: **find the poison, the cure, and the hand — "complete this," or be just another Michio.**
- **Last beat:** Akihiko used **Katana of Fire** + Blazing Tears to ease the stricken (fatigue only — palliative, no cure; none burned → no Taint, a human crime); **Earth·Medicine** ID'd the poison & antidote (a riverbank herb); **Earth·Survival + Void** rallied the whole company to forage it. He **saves most of the company**, loses the worst-gone. (GM-corrected: Fear of Failure is Water-gated; it wrongly fired on these Earth checks — strife is **4/8, not Compromised**; the "breaking point" beat is retracted.)
- **Akihiko's state:** strife **4/8**, fatigue **3/10**, **Void 1/2** (spent 1), no wounds. Honor 57 · Glory 32 · Status 36. Strained but holding.
- **Stakes / open:** the **poisoner** still walks the camp (leads: the sake supply/quartermaster, who served the feast, an 'attractive' ashigaru-entertainer at the feast's center); whether more tainted sake circulates; Saburō's clock. The investigation is live.
