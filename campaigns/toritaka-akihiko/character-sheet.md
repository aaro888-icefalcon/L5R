...
*(Adapted from Abhishek "Shake" Rao)*
...
## Advantages
- **Sixth Sense (Void)** [distinction] — feels the presence of hidden spirits (ominous when their intent is evil); reroll up to 2 dice on hunch checks (e.g., Meditation [Void] duel initiative; Theology [Void]).
- **Stories (Earth)** [passion] — folktales & ballads; reroll up to 2 on relevant checks; cancels a paired anxiety on a shared check.
- **Blessed Lineage (Void)** [distinction — Imperial] — characters of Status 50+ will not choose to kill him as a first option, lest harming Imperial blood cost them prestige.
...
- **Softheartedness (Fire)** [anxiety] — given the choice to kill or spare, he *always* spares; 3 strife after kill-related checks (1 Void first time/scene).
...
- **Marked by the Deep (Void)** [adversity — Curse, Spiritual; *gained Scene 4*] — the deep-Shinomen power set a hook in his soul over his heart. It can sense roughly where he is and reach for him across thresholds; spirits of the deep are drawn to him; the mark aches near breaches/Taint. *Bad-reroll* (choose & reroll 2 dice showing success) on checks to hide from / resist the power and its servants; gain 1 Void on failure. **Double-edged:** the same wound lets *his* spirit-sight reach back — he can faintly sense when/where the power stirs (a GM-facilitated lead). **CONTAINED (Cleansing Rite, Sc.4):** cannot deepen or spread, and its *beacon is blunted* — the power struggles to find/reach him for a while. True removal needs the First Ward (or the power's undoing).
...
- **Moshi Hizashi** — father; brilliant, scattered, entrepreneurial Centipede sun-priest-physician; a "radical" Moshi who treats invocations as natural philosophy. *(Bhaskar)*
- **Toritaka Sumiko** — mother; retired, grounded Falcon healer-warden; the family bedrock; quietly carries the hidden Imperial lineage. *(Sudha)*
- **Lord Toritaka Hatsue, the Yotogi** — daimyō & hard mentor; spirit-seer whose mind frays from what she sees.
...
## Gear / koku
- **3 koku**
- **Light lacquered field armor** [Physical 3] — worn on the mortal road · **Sanctified robes** [Physical 1 / **Supernatural 3**] — shugenja vestments, worn vs the spirit-dark (*only one armor's resistance applies at a time — choose loadout to the threat*) · **daishō** (katana + wakizashi) with ray-etched scabbard · **bō** (staff) · scroll satchel · traveling pack · religious texts
